...
// on declare la class formateur qui herite de model 
 
Formateur.init( // on initialise le model 
    { 
        id_formateur: { // on declare les champs de la table 
